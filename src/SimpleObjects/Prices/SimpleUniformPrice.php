...
/**
 * Represents a Simple fund where all of the values are going to be the same
 */
class SimpleUniformPrice implements EndOfDayPrices
{
    /**
     * @var Fund
     */
     ...
     * @var Money
     */
    private $uniformPrice;

    public function __construct(Fund $fund, DateTimeImmutable $date, Money $uniformPrice)
    {
        $this->fund = $fund;
        $this->date = $date;
